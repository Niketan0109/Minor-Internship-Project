...
net = cv2.dnn.readNet("C:\\Users\\niket\\Downloads\\yolov3.weights", "C:\\Users\\niket\\Downloads\\yolov3.cfg")

classes = ["person"]

with open("C:\\Users\\niket\\Downloads\\coco.names", "r") as f:
...
while(cap.isOpened()):
    ...
    if len(indexes)>0:        
        ...
        for i in idf:            
            ...
            cv2.putText(img, "Social Distancing Detection ", (255, 45),font, 1, (255, 255, 255), 2)
